...
return [
    ...
    */
    ...
    'database' => [
        'tables' => [
            'hidden' => ['migrations', 'newsletter', 'pages', 'categories', 'personal_access_tokens', 'users', 'user_roles', 'failed_jobs', 'posts', 'permissions', 'translations', 'roles', 'menus', 'data_rows', 'data_types', 'menu_items', 'password_resets', 'permission_role', 'settings'],
        ],
