...
const changeLanguage = (language) => {
 ...
 function navibar  ({ match, location }){
                ...
                <div className='menu-section'>
                    <nav>
                        <ul>
                            ...
                            <li><Link to={generateLanguage("az", location)}><button onClick={() => changeLanguage("az")}>az</button></Link></li>
                            <hr className='horizontal-divider' />
                            <li><Link to={generateLanguage("en", location)}><button onClick={() => changeLanguage("en")}>en</button></Link></li>
