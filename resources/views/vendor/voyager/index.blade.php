...
@section('content')
    <div class="page-content">
        ...
        <div class="analytics-container">
            ...
            @else
                <p>TUT MOJNO WTO TO POSTAVIT, SEMRALE PRODUCTION</p>
            ...
            <div class="Dashboard Dashboard--full" id="analytics-dashboard">
                <p>{{ __('voyager::analytics.krm_day') }}: <span id="krm_day"></span></p>
                <p>{{ __('voyager::analytics.krm_week') }}: <span id="krm_week"></span></p>
                <p>{{ __('voyager::analytics.krm_year') }}: <span id="krm_year"></span></p>
            ...
            gapi.analytics.ready(function () {
                ...
                function renderWeekOverWeekChart(ids) {
                    ...
                    Promise.all([thisWeek, lastWeek]).then(function (results) {
                        ...
                        document.getElementById('krm_day').innerHTML = results[0].rows[results[0].rows.length - 1][2];
                        
                        document.getElementById('krm_week').innerHTML = results[0].totalsForAllResults['ga:users'];
                ...
                function renderYearOverYearChart(ids) {
                    ...
                    Promise.all([thisYear, lastYear]).then(function (results) {
                        ...
                        document.getElementById('krm_year').innerHTML = results[0].totalsForAllResults['ga:users'];
